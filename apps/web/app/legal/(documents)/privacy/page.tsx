...
const Privacy = () => (
  <>
    ...
    <p>
      ...
      name, address, and date of birth), your devices, and even information
    ...
    <p>
      ...
      account or when you contact us — which may include one or more of the
      following:
    </p>
    <ul>
      <li>Name</li>
    ...
    <p>
      ...
      publication, processing, or usage on our platform. All user-generated
    ...
    <p>
      ...
      Once published, it may be accessible to third parties not covered under
      this privacy policy.
    </p>
    ...
    <p>
      ...
      other trusted sources. For example, If you provide us with your location,
      we may combine this with general information about currency and language
      to provide you with an enhanced experience of our site and service.
    </p>
    ...
    <p>
      ...
      with personal information as part of creating an account with us, we may
      retain this information for the duration your account exists on our
    ...
    <ul>
      ...
      <li>
        ...
        loggers, maintenance or problem-solving providers, and professional
        advisors
      </li>
    ...
    <p>
      ...
      service or offer (for example processing transaction data), we will not
      ...
      or imposing penalties, or provide you with a different level or quality of
      goods or services.
    </p>
    <p>
    ...
    <p>
      ...
      will take to deal with your complaint. You also have the right to contact
    ...
    <p>
      ...
      they will be required to assume as it is the basis for any ownership or
    ...
    <p>
      ...
      contact you (based on your selected preferences for communications from
      us) and all our registered users with the new details and links to the
    ...
    <p>
      ...
      any act or practice that contravenes the Australian Privacy Principles, it
      would not be accountable under the Privacy Act, and you will not be able
    ...
    <p>
      ...
      legal right to do so. In which case, we will collect and use your personal
      information lawfully, fairly, and in a transparent manner. If we seek your
      consent to process your personal information, and you are under 16 years
      of age, we will seek your parent or legal guardian’s consent to process
    ...
    <p>
      ...
      your enquiry. While you may request that we delete your contact details at
      any time, we cannot recall any email we have already sent. If you have any
      further enquiries about how to withdraw your consent, please feel free to
    ...
    <p>
      ...
      our legitimate interests to include research and development,
      understanding our audience, marketing and promoting our services, measures
      taken to operate our services efficiently, marketing analysis, and
    ...
    <p>
      ...
      records. If you ask us to delete your personal information, we will let
      ...
      once, like certain profile information and public comments, even after you
    ...
    <p>
      ...
      Rights Request” in the first line of the description and include your
