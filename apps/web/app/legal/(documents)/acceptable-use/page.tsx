...
const description =
  "This acceptable use policy covers the products, services, and technologies (collectively referred to as the “Products”) provided by Portal under any ongoing agreement.";
...
const Privacy = () => (
  <>
    ...
    <p>
      Portal customers found engaging in activities prohibited by this
    ...
    <h3>Unauthorized use of Portal property</h3>
    <p>
      We prohibit the impersonation of Portal, the representation of a
      significant business relationship with Portal, or ownership of any Portal
